...
export const ART = {
  ...
  saudi: (T) => `<svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" stroke-linejoin="round" stroke-linecap="round"><style>
...
</style><g class="dlh"><ellipse cx="60" cy="106" rx="21" ry="3.2" fill="${T.deep}" opacity=".2"/><path class="dlh-steam" d="M64 30 q6 -7 1 -14 q-4 -6 1 -12" stroke="${T.accent2}" stroke-width="2.6" opacity=".6"/><path class="dlh-steam s2" d="M56 30 q-6 -7 -1 -14 q4 -6 -1 -12" stroke="${T.accent2}" stroke-width="2.4" opacity=".5"/><g class="dlh-pot"><path d="M45 99 Q60 104 75 99 L71 93 L49 93 Z" fill="${T.accent}" stroke="${T.deep}" stroke-width="2.4"/><path d="M49 93 Q41 80 42 63 Q43 50 60 47 Q77 50 78 63 Q79 80 71 93 Z" fill="${T.accent}" stroke="${T.deep}" stroke-width="2.6"/><path class="dlh-band" d="M45 73 Q60 79 75 73" stroke="${T.deep}" stroke-width="1.5" opacity=".45"/><path class="dlh-band" d="M47 62 Q60 67 73 62" stroke="${T.accent2}" stroke-width="1.7"/><path d="M53 47 Q52 41 60 41 Q68 41 67 47" fill="${T.accent}" stroke="${T.deep}" stroke-width="2.3"/><path d="M53 44 Q33 41 22 22 Q20.5 18.5 25 18 Q33 34 55 41 Z" fill="${T.accent2}" stroke="${T.deep}" stroke-width="2.3"/><path d="M67 47 Q85 49 85 68 Q85 81 74 84" stroke="${T.deep}" stroke-width="3.6"/><path d="M67 47 Q85 49 85 68 Q85 81 74 84" stroke="${T.accent}" stroke-width="1.5"/><path d="M50 41 Q60 27 70 41 Z" fill="${T.accent2}" stroke="${T.deep}" stroke-width="2.3"/><path d="M60 28 L60 18" stroke="${T.deep}" stroke-width="2.3"/><path class="dlh-cres" d="M56 16 A5 5 0 1 0 62 12 A3.6 3.6 0 1 1 56 16 Z" fill="${T.accent2}" stroke="${T.deep}" stroke-width="1.8"/><path class="dlh-stream" d="M22 22 q-5 10 -4 22" stroke="${T.accent2}" stroke-width="3" stroke-linecap="round"/><ellipse class="dlh-drop" cx="18" cy="46" rx="2.6" ry="3.4" fill="${T.accent2}"/></g></g></svg>`,
};
