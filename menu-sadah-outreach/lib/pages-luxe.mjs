...
export const ART = {
  ...
  saudi: (T) => `<svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" stroke-linejoin="round" stroke-linecap="round"><defs><linearGradient id="dBody" x1=".28" y1="0" x2=".8" y2="1"><stop offset="0" stop-color="#f7e6ab"/><stop offset=".26" stop-color="#e6bd5c"/><stop offset=".58" stop-color="#c6902c"/><stop offset="1" stop-color="#785318"/></linearGradient><linearGradient id="dGold" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#faefc6"/><stop offset=".5" stop-color="#d9ad48"/><stop offset="1" stop-color="#87611e"/></linearGradient><radialGradient id="dSheen" cx=".36" cy=".26" r=".6"><stop offset="0" stop-color="#fff9e6" stop-opacity=".9"/><stop offset=".55" stop-color="#fff9e6" stop-opacity="0"/></radialGradient></defs><style>
