...
<div class="wrap">
  ...
  <div class="card">
    <ul class="benefits">
      ...
      <li><span class="tick">✓</span><span><span class="ar">جاهز لاشتراطات هيئة الغذاء والدواء — خانات السعرات والكافيين مدعومة</span><span class="en">SFDA-ready — calorie & caffeine fields supported out of the box</span></span></li>
